...
Flags: bit 0 buffer available, bit 1 armed, bit 2 awaiting resume, bit 3 stopping/draining, bit 4 connected replay supported. Older firmware leaves byte 3 and bit 4 zero; older apps ignore these additions.
