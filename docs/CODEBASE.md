...
The authoritative installable version is the `ota-releases` feed. At this review it reports **build 1402** for all three targets, source commit `e63af76e2c8a764109f4d572d26b4b71ce7787c7`.
