...
function validate(bytes,build) {
  ...
  for(const marker of ['SYNAP-ESP32S3-OTA-AUTH-V2',`SYNAP-FW:${target}:${version}:${build}\0`]) {
...
if(require.main===module) {
  ...
  const manifest={schema:1,version,build,target,protocol:2,chip:9,flashBytes:4194304,psramBytes:2097152,
