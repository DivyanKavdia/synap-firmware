...
test('Chakshu SD remains the durable offline inbox without capture-time remounts',()=>{
  ...
  // Local Hey Snap remains valid with BLE connected, but local jobs still obey
  // epoch/resource serialization and remote BLE clients cannot redirect SD audio/video.
